...
You can install the development version of trackingfootballR from [GitHub](https://github.com/) with:
...
This is a basic example which shows you how to utilize the functions of trackingfootballR and return JSON listed data:
